...
<div class="container py-5" style="background: #f8fafc; min-height: 100vh;">
    <h2 class="mb-4" style="color: #222;">Edit Tenant</h2>
    @if ($errors->any())
                    ...
                    <div class="tab-pane fade show active" id="customer" role="tabpanel">
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="data[title]" value="{{ $tenant->data['title'] ?? '' }}" autocomplete="honorific-prefix">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="first_name" style="color: #333;">First Name</label>
                                <input type="text" class="form-control" id="first_name" name="data[first_name]" value="{{ $tenant->data['first_name'] ?? '' }}" autocomplete="given-name">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="last_name" style="color: #333;">Last Name</label>
                                <input type="text" class="form-control" id="last_name" name="data[last_name]" value="{{ $tenant->data['last_name'] ?? '' }}" autocomplete="family-name">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label for="phone" style="color: #333;">Phone</label>
                                <input type="tel" class="form-control" id="phone" name="data[phone]" value="{{ $tenant->data['phone'] ?? '' }}" autocomplete="tel">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label for="email" style="color: #333;">Email</label>
                                <input type="email" class="form-control" id="email" name="data[email]" value="{{ $tenant->data['email'] ?? '' }}" autocomplete="email">
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="company" role="tabpanel">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="company_name" name="data[company_name]" value="{{ $tenant->data['company_name'] ?? ($tenant->data['name'] ?? '') }}" autocomplete="organization">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="company_domain" style="color: #333;">Company Domain</label>
                                <input type="text" class="form-control" id="company_domain" name="data[company_domain]" value="{{ $tenant->data['company_domain'] ?? $tenant->id }}" autocomplete="url">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="company_email" style="color: #333;">Company Email</label>
                                <input type="email" class="form-control" id="company_email" name="data[company_email]" value="{{ $tenant->data['company_email'] ?? '' }}" autocomplete="email">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="company_phone" style="color: #333;">Company Phone</label>
                                <input type="tel" class="form-control" id="company_phone" name="data[company_phone]" value="{{ $tenant->data['company_phone'] ?? '' }}" autocomplete="tel">
                            </div>
                            <div class="col-md-8 mb-3">
                                <label for="company_address" style="color: #333;">Company Address</label>
                                <input type="text" class="form-control" id="company_address" name="data[company_address]" value="{{ $tenant->data['company_address'] ?? '' }}" autocomplete="street-address">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="company_login_link" style="color: #333;">Company Login Link</label>
                                <input type="url" class="form-control" id="company_login_link" name="data[company_login_link]" value="{{ $tenant->data['company_login_link'] ?? '' }}" autocomplete="url">
                            </div>
                        </div>
                    </div>
