...
<html lang="en">
    <head>
        ...
        <title>Savirix &mdash; Modern Estate Agency Software</title>
        <meta name="description" content="Savirix modernises estate agency operations with automated CRM, lettings, and compliance workflows.">
    ...
    <body class="bg-white text-dark">
        <nav class="navbar navbar-expand-lg bg-white shadow-sm py-3">
            <div class="container">
                <a class="navbar-brand fw-bold" href="/">Savirix</a>
        ...
        <footer id="contact" class="bg-dark text-white py-4 mt-5">
            <div class="container text-center small">
                &copy; 2025 Savirix Ltd. Not affiliated with Apex27. All rights reserved.
            </div>
        </footer>
