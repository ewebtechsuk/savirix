...
For observability and health checks, see [production-observability.md](./production-observability.md). Deploys now fail automatically if tenancy health breaks, and Sentry will tag errors per tenant/host/role for faster debugging.
